  ...
  return (
    <div>
      <div className="flex flex-col items-center mt-28 mb-40 sm:flex-row">
        <div className="w-full sm:w-7/12 mx-auto text-center sm:text-left mb-6 order-2 sm:order-1">
          <h1 className="text-5xl mb-5 p-5 text-center font-semibold">
            About Me{" "}
          ...
          <div className="text-xl font-sans  text-justify">
            <p>
        ...
        <div className="order-1 sm:order-2 p-6">
